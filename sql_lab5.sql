...
-- Написать запрос, выводящий список должников на текущий момент времени. Должны выводиться поля: код студента, ФИО студента, курс, 
-- код предмета, название предмета, семестр, оценка (2 – если сдавал экзамен, нулл – если не сдавал).
create or replace 
